...
public class PLSQLFromJava {
   ...
   public static void main( String[] args ) {
      ...
      try {
         ...
         CallableStatement vStatement = vDatabaseConnection.prepareCall( "begin t2_bss.insertNewAmbBenProgEffdt( ?, ? ); end;" );
         ...
         //  not needed for this statement   ----vStatement.registerOutParameter( 3, Types.VARCHAR );   // declare type of second function parameter "..., ? ); end;"
